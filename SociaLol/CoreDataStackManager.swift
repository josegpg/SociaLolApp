...
private let SQLITE_FILE_NAME = "SociaLol.sqlite"
...
class CoreDataStackManager {
    ...
    */
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.josepinero.VirtualTourist" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SociaLol", withExtension: "momd")!
